444import "module-alias/register";
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    bsctestnet: {
      url: process.env.ARCHIVE_NODE_bsctestnet || "https://data-seed-prebsc-1-s1.ainomo.com:8545",
      chainId: 97,
      live: true,
    ...
    bscmainnet: {
      url: process.env.ARCHIVE_NODE_bscmainnet || "https://bsc-dataseed.ainomo.com/",
      chainId: 56,
      live: true,
      timeout: 1200000, 
    },
